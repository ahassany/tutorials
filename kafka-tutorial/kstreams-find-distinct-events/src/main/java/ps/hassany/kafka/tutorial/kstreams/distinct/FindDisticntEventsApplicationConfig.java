...
@Data
public class FindDisticntEventsApplicationConfig {
  ...
  public static FindDisticntEventsApplicationConfig build(Properties props) {
    ...
    return new FindDisticntEventsApplicationConfig(
        bootstrapServers,
        applicationId,
        schemaRegistryURL,
        inputTopicName,
