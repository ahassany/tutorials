...
public class OrderToNodesTest {
  ...
  public void init() throws IOException {
    ...
    ordersWithStateStream
        .flatMap(nodesMapper)
        .to(outTopicName, Produced.with(stringSerde, nodeSerde));
  }
  ...
  public void test_transformOneOrder() {
    ...
    try (final TopologyTestDriver topologyTestDriver =
      ...
      final TestOutputTopic<String, DomainNode> output =
          topologyTestDriver.createOutputTopic(
              outTopicName, stringSerde.deserializer(), nodeSerde.deserializer());
